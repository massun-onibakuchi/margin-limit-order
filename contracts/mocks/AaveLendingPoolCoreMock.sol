...
contract AaveLendingPoolCoreMock is IAaveLendingPoolCore {
    ...
    function getReserveInterestRateStrategyAddress(address) external view override returns (address) {
        return reserve;
    }
    ...
    function getReserveCurrentAverageStableBorrowRate(address) external view override returns (uint256) {
    ...
    function getReserveCurrentLiquidityRate(address) external view override returns (uint256 liquidityRate) {
        return apr;
    }
